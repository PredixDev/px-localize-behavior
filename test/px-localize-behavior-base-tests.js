...
function runBaseTests() {
  px_localize_behavior_1 = document.getElementById('px_localize_behavior_1');

  suite('Base Automation Tests for px-localize-behavior', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-localize-behavior fixture is created', function() {
      assert.isTrue(document.getElementById('px_localize_behavior_1') !== null);
    });
